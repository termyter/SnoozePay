...
function FiringTopUpOneTap() {
  return (
    <DawnDimBackground>
      ...
      <div style={{ position: "absolute", inset: 0, padding: "54px 24px 32px",
  ...
  return (
    <div style={{ position: "absolute", inset: 0, background: "var(--sp-bg-0)", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ paddingTop: 54, flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        ...
        <div style={{ padding: "20px 20px 0", flex: 1, overflowY: "auto", display: "flex", flexDirection: "column", gap: 10 }}>
