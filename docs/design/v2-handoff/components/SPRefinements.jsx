...
function FiringDawnProgressive({ stage = 1 }) {
  ...
  return (
    <div style={{ position: "absolute", inset: 0, overflow: "hidden",
      ...
      <div style={{ position: "absolute", inset: 0, paddingTop: 54, padding: "54px 16px 32px",
  ...
  return (
    <div style={{ position: "absolute", inset: 0, background: "var(--sp-bg-0)", overflow: "hidden", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        ...
        <div style={{ padding: "16px 16px 0", flex: 1, overflowY: "auto", display: "flex", flexDirection: "column", gap: 16 }}>
          {/* Hero */}
